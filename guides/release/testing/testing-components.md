...
Imagine you have a typeahead component that uses [`debounce`](https://api.emberjs.com/ember/release/functions/@ember%2Frunloop/debounce) to limit requests to the server, and you want to verify that results are displayed after typing a character.
